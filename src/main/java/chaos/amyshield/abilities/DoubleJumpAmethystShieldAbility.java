...
public record DoubleJumpAmethystShieldAbility() implements AmethystShieldAbility {
    @Override
    public float getChargeCost() {
        return AmethystShield.CONFIG.amethystShieldNested.doubleJumpNested.DOUBLE_JUMP_COST();
    }
