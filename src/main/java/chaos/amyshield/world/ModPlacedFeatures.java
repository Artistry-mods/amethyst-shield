...
public class ModPlacedFeatures {
    ...
    public static final RegistryKey<PlacedFeature> DIAMOND_DEPOSIT_PLACED_KEY = registerKey("diamond_deposit_placed");
    ...
    public static RegistryKey<PlacedFeature> registerKey(String name) {
        return RegistryKey.of(RegistryKeys.PLACED_FEATURE, new Identifier(AmethystShield.MOD_ID, name));
    }
